...
const Tasks = ({ setIsLoading }) => {
    ...
    return (
        <div className="taskContainer">
                ...
                <div className="table">
                    ...
                    <div className="footer">
                        <div className="pagination">
                            ...
                            <button className="pageButton" onClick={() => (page < Math.ceil(sortedHeap.length / MAX_PER_PAGE) - 1 ? setPage(page + 1) : setPage(0))}>
                                Next
                            </button>
                        </div>
                    </div>
            ...
            {task ? <TaskDetails setIsLoading={setIsLoading} task={task} setTask={setTask} /> : ""}
        </div>
    );
};
