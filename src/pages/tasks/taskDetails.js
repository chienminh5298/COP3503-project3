...
const TaskDetails = ({ task, setTask, setIsLoading }) => {
    // Handle detail task
                ...
                <div className="generalInfo">
                    ...
                    <div className="taskPriority">
                        ...
                        <div className="priorityOption">
                            ...
                            <div>
                                <input type="radio" id="medium" name="priority" value="Medium" defaultChecked={task.getPriority() === "Medium"} {...register("priority")} />
